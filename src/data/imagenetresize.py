...
class ImageNet_Resize_Filter(datasets.ImageFolder):
    """ImageNet_Crop Dataset.
    """
...
def getImageNetResizeDataset(data_path='./data', **args):
    """
    image: 32, 32
    """
    log(' ---------------- Get Dataset: ImageNet-Resize --------------- ')
    ## image size: [3, 64, 64]
    ...
    dataset = ImageNet_Resize_Filter(os.path.join(data_path, 'Imagenet_resize', data_split), transform)
