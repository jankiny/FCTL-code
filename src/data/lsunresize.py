...
class LSUN_Resize_Filter(datasets.ImageFolder):
    """LSUN_Resize Dataset.
    """
...
def getLSUNResizeDataset(data_path='./data', **args):
    """
    image: 32, 32
    """
    log(' ---------------- Get Dataset: LSUN-Resize --------------- ')
    ## image size: [3, 64, 64]
    ...
    dataset = LSUN_Resize_Filter(os.path.join(data_path, 'LSUN_resize', data_split), transform)
