...
class ImageNet_Crop_Filter(datasets.ImageFolder):
...
def getImageNetCropDataset(data_path='./data', **args):
    """
    image: 32, 32
    """
    log(' ---------------- Get Dataset: ImageNet-Crop --------------- ')
    ## image size: [3, 64, 64]
    ...
    dataset = ImageNet_Crop_Filter(os.path.join(data_path, 'Imagenet_crop', data_split), transform)
